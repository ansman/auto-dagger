...
dependencies {
    ...
    implementation("se.ansman.dagger.auto:core:0.5.0")
    kapt("se.ansman.dagger.auto:compiler:0.5.0")

    // Include this only in android modules
    implementation("se.ansman.dagger.auto:android:0.5.0")
    // Add these if you want to replace objects during tests
    testImplementation("se.ansman.dagger.auto:android-testing:0.5.0")
    kaptTest("se.ansman.dagger.auto:compiler:0.5.0")
}
```
