...
import se.ansman.dagger.auto.compiler.common.testutils.AutoDaggerCompilation
import se.ansman.dagger.auto.compiler.common.testutils.ResourceBasedTest
import java.io.File


abstract class BaseTest(compilationFactory: AutoDaggerCompilation.Factory) : ResourceBasedTest(compilationFactory) {
    @Nested
