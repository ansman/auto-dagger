...
public object AutoInitializeNonInitializableThingModule {
  @Provides
  @IntoSet
  public
      fun provideNonInitializableThingAsInitializable(nonInitializableThing: Lazy<NonInitializableThing>):
      Initializable = nonInitializableThing.asInitializable()
}