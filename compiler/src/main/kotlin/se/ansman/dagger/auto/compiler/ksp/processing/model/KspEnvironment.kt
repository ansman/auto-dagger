...
import se.ansman.dagger.auto.compiler.ksp.processing.AutoDaggerKspLogger

class KspEnvironment(
    val environment: SymbolProcessorEnvironment,
) : AutoDaggerEnvironment<KSNode, TypeName, ClassName, AnnotationSpec, FileSpec>,
    RenderEngine<KSNode, TypeName, ClassName, AnnotationSpec> by KotlinPoetRenderEngine {
    ...
    override fun write(output: FileSpec) {
        output.writeTo(environment.codeGenerator, aggregating = false)
    }
}