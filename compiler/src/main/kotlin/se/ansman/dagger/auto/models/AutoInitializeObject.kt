...
data class AutoInitializeObject<out TypeName, out AnnotationSpec>(
    ...
    companion object {
        internal val autoInitialize = AutoInitialize::class
        ...
        internal fun <Method : Any, Type : Any, TypeDeclaration : Any, TypeName, AnnotationSpec> fromMethod(
        ...
        ): AutoInitializeObject<TypeName, AnnotationSpec> {
            ...
            if (module.getTypeAnnotations().none { it.isOfType(AutoInitializeObject.module) }) {
                throw error(Errors.methodInNonModule, method)
            }
            ...
            return AutoInitializeObject(
                targetType = targetType,
                priority = annotations.first { it.isOfType(autoInitialize) }.getValue("priority"),
        ...
        ): AutoInitializeObject<ClassName, AnnotationSpec> {
