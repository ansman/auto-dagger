package se.ansman.dagger.auto.compiler.common.androidx.room.models
...
data class AndroidXRoomDatabaseModule<E, TypeName, ClassName : TypeName>(
    ...
    override val originatingElement: E,
    val databaseType: ClassName,
    val daos: List<Dao<TypeName>>,
) : HiltModule<E, ClassName> {
