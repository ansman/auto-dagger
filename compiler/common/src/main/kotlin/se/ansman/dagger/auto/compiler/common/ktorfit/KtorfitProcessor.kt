package se.ansman.dagger.auto.compiler.common.ktorfit
...
import se.ansman.dagger.auto.compiler.common.retrofit.BaseApiServiceProcessor
...
class KtorfitProcessor<N, TypeName, ClassName : TypeName, AnnotationSpec, F>(
    ...
    renderer = renderer,
    annotation = "se.ansman.dagger.auto.ktorfit.AutoProvideService",
