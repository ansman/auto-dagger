...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Returns the group of libraries at anvil
     */
    public AnvilLibraryAccessors getAnvil() { return laccForAnvilLibraryAccessors; }
     ...
     */
    public KotlinpoetLibraryAccessors getKotlinpoet() { return laccForKotlinpoetLibraryAccessors; }
    ...
    public static class AnvilLibraryAccessors extends SubDependencyFactory {
        private final AnvilCompilerLibraryAccessors laccForAnvilCompilerLibraryAccessors = new AnvilCompilerLibraryAccessors(owner);

        public AnvilLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at anvil.compiler
         */
        public AnvilCompilerLibraryAccessors getCompiler() { return laccForAnvilCompilerLibraryAccessors; }

    }

    public static class AnvilCompilerLibraryAccessors extends SubDependencyFactory {

        public AnvilCompilerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for api (com.squareup.anvil:compiler-api)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getApi() { return create("anvil.compiler.api"); }

            /**
             * Creates a dependency provider for utils (com.squareup.anvil:compiler-utils)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getUtils() { return create("anvil.compiler.utils"); }
    ...
    public static class KotlinpoetLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        public KotlinpoetLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() { return create("kotlinpoet"); }

            /**
             * Creates a dependency provider for ksp (com.squareup:kotlinpoet-ksp)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getKsp() { return create("kotlinpoet.ksp"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: anvil (2.4.3)
            ...
            /**
             * Returns the version associated to this alias: kotlinpoet (1.12.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        public BundleAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
             ...
             * This bundle was declared in catalog libs.versions.toml
             */
            public Provider<ExternalModuleDependencyBundle> getKotlinpoet() { return createBundle("kotlinpoet"); }
